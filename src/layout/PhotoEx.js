...
import gan1 from "../images/ganseoLib.svg";
import gan2 from "../images/gan2.svg";
import gan3 from "../images/gan3.svg";
import gan4 from "../images/gan4.svg";
import gan5 from "../images/gan5.svg";
...
function PhotoEx() {
  ...
  return (
    <>
      {id == 1 ? (
        <div className="photoExWrap">
          <div className="ascPhotoWrap">
            <div className="ascImg">
              <img src={ak1} alt="" />
            </div>
            <div className="ascEx">
              시간이 지나면 페이드로 변하는 메인 페이지{" "}
            </div>
          </div>
        ...
        <div className="photoExWrap">
          ...
          <div className="dscPhotoWrap">
            ...
            <div className="ascEx">
              상단에는 유저의 주소
              <br /> 주변의 반려견들과
              <br /> 내위치보기로 현재위치, 지도를 드래그해서 현위치 검색으로
              지도 중심 주변 모임확인
            </div>
          </div>
          <div className="ascPhotoWrap">
      ...
      {id == 4 ? (
        <div className="photoExWrap">
          ...
          <div className="ascPhotoWrap">
            ...
            <div className="ascEx">
              공공데이터의 캠핑장 정보와 지역 날씨 정보, 카카오결제 시스템
            </div>
          </div>
          <div className="dscPhotoWrap">
            <div className="ascImg">
      ...
      {id == 5 ? (
        <div className="photoExWrap">
          ...
          <div className="dscPhotoWrap">
            ...
            <div className="ascEx">11개의 여려 메뉴의 보기 편한 화면 구성</div>
          </div>
          <div className="ascPhotoWrap">
            <div className="ascImg">
              <img src={gan3} alt="" />
          ...
          <div className="dscPhotoWrap">
            ...
            <div className="ascEx">강서 도서관의 정보 전달</div>
          </div>
          <div className="ascPhotoWrap">
            <div className="ascImg">
              <img src={gan5} alt="" />
            </div>
            <div className="ascEx">강서 도서관의 배치도</div>
          </div>
        </div>
      ) : (
        ""
